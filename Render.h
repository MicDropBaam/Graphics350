...
public:
	...
	void DivideColor(Camera* camera, Shader* shader, float aspect, glm::vec3 m_position);
	void BspColor(Camera* camera, Shader* shader, float aspect, glm::vec3 m_position);
